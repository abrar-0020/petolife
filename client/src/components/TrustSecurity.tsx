          ...
          >
            {trustPoints.map((point, idx) => {
              ...
              return (
                <motion.div
                  key={idx}
                  className={`relative group ${idx % 2 === 1 ? 'md:mt-4' : ''}`}
                  variants={itemVariants}
                >
                  {/* Card with gradient background */}
                  <div className={`bg-gradient-to-br ${point.color} rounded-xl p-8 border border-border card-hover-premium h-full`}>
                    {/* Icon */}
                    <div className="w-12 h-12 bg-white rounded-lg flex items-center justify-center mb-6 shadow-sm group-hover:shadow-md transition-shadow duration-500">
          ...
          >
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
              {[
                ...
                <motion.div
                  key={idx}
                  className="text-center p-4 bg-background rounded-lg border border-border card-hover-premium"
