 ...
 * - Clear call-to-action with ambient glow
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            >
              ...
              <div className="absolute -inset-3 bg-accent/15 rounded-2xl blur-xl" style={{ animation: 'ambient-pulse 3s ease-in-out infinite' }} />
              <motion.button
                className="relative inline-flex items-center gap-2 px-10 py-4 bg-accent text-white font-semibold rounded-lg hover:shadow-2xl transition-all duration-300"
            ...
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <p className="text-sm text-foreground/60 mb-6">Trusted by leading veterinary clinics and pet parents</p>
