            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
              {steps.map((step, idx) => {
                ...
                return (
                  ...
                  >
                    {/* Step Card */}
                    <div className="bg-white rounded-xl p-8 border border-border card-hover-premium h-full">
                      {/* Step number badge */}
                      <div className="absolute -top-4 -left-4 w-10 h-10 bg-accent text-white rounded-full flex items-center justify-center font-bold text-lg shadow-lg" style={{ boxShadow: '0 4px 12px rgba(46, 125, 90, 0.3)' }}>
                        {step.number}
                      </div>
