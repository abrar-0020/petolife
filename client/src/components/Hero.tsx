      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          >
            ...
            <motion.p
              variants={itemVariants}
              className="text-lg sm:text-xl text-foreground/70 max-w-lg leading-relaxed"
            >
          ...
          >
            ...
            <motion.div
              className="hidden md:block absolute -bottom-6 -right-6 lg:-bottom-12 lg:-right-20 bg-white rounded-xl shadow-xl p-6 max-w-xs border border-border z-10"
              animate={{ y: [0, -12, 0] }}
            ...
            <motion.div
              className="hidden md:block absolute -top-6 -left-6 lg:-top-12 lg:-left-24 bg-white rounded-xl shadow-xl p-5 max-w-xs border border-border z-10"
              animate={{ y: [0, -12, 0] }}
