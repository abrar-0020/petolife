  ...
  return (
    <section className="relative bg-background py-24 sm:py-32 overflow-hidden">
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
          {scenarios.map((scenario, idx) => {
            ...
            return (
              ...
              >
                {/* Card */}
                <div className="bg-white rounded-xl p-6 border border-border text-center h-full">
        ...
        {/* CTA Message */}
        <motion.div
          className="bg-gradient-to-r from-accent/10 to-primary/10 rounded-xl p-8 border border-accent/20 text-center"
          initial={{ opacity: 0, y: 20 }}
          whileInView={{ opacity: 1, y: 0 }}
